...
| Session | The host stores messages, Parts, busy/idle, and native permission/question | O4E stores the Agent/Command Task ledger in Session metadata; Workflow stores only the owner checkpoint and builds no background ledger |
